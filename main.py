...
def generar_pdf(folio, marca, linea, año, serie, motor, color, contribuyente, fecha_expedicion, fecha_vencimiento):
    ...
    page.insert_text((376, 441), año, fontsize=8)
    ...
    page.insert_text((500, 100), motor, fontsize=19, rotate=270, color=(0, 0, 0))
    page.insert_text((300, 100), marca, fontsize=19, rotate=270, color=(0, 0, 0))
